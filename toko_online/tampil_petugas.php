...
<body>
    <div class="sidebar">
        ...
        <a href="#"><i class="fas fa-users"></i> Lihat Petugas</a>
                ...
                <tbody>
                    ...
                    while ($data_petugas = mysqli_fetch_array($qry_petugas)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="ubah_petugas.php?Id=<?=$data_petugas['id_petugas']?>" class="btn btn-success btn-sm btn-custom"><i class="fas fa-edit"></i> Ubah</a>
                                    <a href="hapus.php?Id=<?=$data_petugas['id_petugas']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger btn-sm btn-custom"><i class="fas fa-trash"></i> Hapus</a>
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
